...
for i = 1:size(participants,2)
    ...
    for individual = 1:size(allparti,1)
        ...
        if userandom ==1 & contains(participants{i},'M')
            save([filepath,touchtype '_' rule '_' num2str(setsize) '_' allparti{individual,:} '_SqnsTable_random.mat'],'*SqnsTable','sqnsACtable','stpACtable','stpACtable2','ptrnACtable','sqnsInptrnACtable','sqnsInptrnACordertable');
        else
            save([filepath,touchtype '_' rule '_' num2str(setsize) '_' allparti{individual,:} '_SqnsTable.mat'],'*SqnsTable','sqnsACtable','stpACtable','stpACtable2','ptrnACtable','sqnsInptrnACtable','sqnsInptrnACordertable');
        end
    end
