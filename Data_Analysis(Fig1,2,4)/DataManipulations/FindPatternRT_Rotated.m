function FindPatternRT_Rotated(participants,rule,touchtype,setsize,N,usetrimed,userandom)
...
%         dataset.responses(dataset.responses == 0) = 6;
    ...
    if userandom ==1 & contains(participants{i},'M')
        save([filepath,touchtype '_' rule '_' num2str(setsize) '_SqnsRTTable_random.mat'],'sqnsRTtable','ptrnRTtable','sqnsInptrnRTtable',...
            'stpRTtable','stpRTtable2');
    else
        save([filepath,touchtype '_' rule '_' num2str(setsize) '_SqnsRTTable.mat'],'sqnsRTtable','ptrnRTtable','sqnsInptrnRTtable',...
            'stpRTtable','stpRTtable2');
    end
