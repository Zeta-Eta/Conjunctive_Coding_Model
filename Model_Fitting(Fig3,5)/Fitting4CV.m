% Fitting across all Patterns for Repeated K-fold Cross-Validation
    ...
    for n = 1:N
        for k = 1:K
            ...
            for mdlsn = 1:size(mdls, 1)
                ...
                %% Model Fitting
                tic;
                FittingResults = ModelFitting(trainingSet, testSet, ModelName, ...
                ...
                savePath = ['FittingResults4CV\', ModelName(1:6), '\'];
