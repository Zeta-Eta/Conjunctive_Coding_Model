function FittingResults = ...
    ModelFitting(trainingSet, testSet, ModelName, ...
    initialParams, Experiment, LossFunction)
...
func = @(params) Model(params, Experiment, trainingSet, LossFunction);
...
[RSS, ModelParams, EncodingMatrix, RetrievalPMF] =...
    Model(modelParams, Experiment, testSet, 'LSE');
