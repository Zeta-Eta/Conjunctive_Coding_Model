% Model Fitting with the Former Half Fixed Params

function FittingResults = ...
    ModelFittingWFHfixedParams(trainingSet, testSet, ModelName, ...
...
func = @(params) Model([fixedParams, params], Experiment, trainingSet, LossFunction);
...
[RSS, ModelParams, EncodingMatrix, RetrievalPMF] =...
    Model([fixedParams, modelParams], Experiment, testSet, 'LSE');
