...
% with Chunk-number(lambda is ralated to the number of chunks in a sequence)

function [L, ModelParams, EncodingMatrix, RetrievalPMF] = ...
    CCM_Cn(Params, Experiment, dataSet, LF)
...
for pattern = 1:patternN
    ...
    Order2Target = exp(- lambda(dataSet.UckNid(pattern)).*Order);
